    ...
    <div className="terms-and-conditions__content">
      ...
      <ul>
        ...
        <li>
          ...
          Vansun Studio, 1007 Granville St, Vancouver, BC V6Z 1M1.
        </li>
        <li>
        ...
        <li>
          ...
          the Company regarding the use of the Service. This Terms and Conditions
          agreement has been created with the help of the Free Terms and Conditions
          Generator.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Vansun Studio, accessible from{" "}
          <a href="https://vansunstudio.com" target="_blank" rel="noopener noreferrer">
            vansunstudio.com
          </a>
          .
        </li>
      ...
      <p>
        ...
        provides no warranty or undertaking, and makes no representation of any kind that
        the Service will meet Your requirements, achieve any intended results, be
      ...
      <p>
        ...
        be uninterrupted or error-free; (iii) as to the accuracy, reliability, or currency
      ...
      <p>
        By email:{" "}
        <a href="mailto:info@vansunstudio.com">info@vansunstudio.com</a>
      </p>
    </div>
  );
}
