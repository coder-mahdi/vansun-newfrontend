  ...
  return (
    <div className="terms-and-conditions__content">
      ...
      <p>
        ...
        <strong>Administered by:</strong> Us
        <br />
        <strong>Purpose:</strong> These Cookies identify if users have accepted the use
      ...
      <p>
        ...
        please visit our Cookies Policy or the Cookies section of this Privacy Policy.
      </p>
