...
/** Client confirms they and any companion may not take photos or video in the piercing room. */
export const piercingConsentNoClientCompanionPhotoVideo =
  "I understand that neither I nor anyone accompanying me may take photographs or record video in the piercing room.";

export const piercingConsentReleaseLine =
  "I release the studio and staff from any liability regarding this procedure.";

export const piercingConsentFinalCheckboxes: string[] = [
